...
export default function DashboardHomePage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-black text-neutral-900 dark:text-white p-6 transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        {servicios.map((s) => (
          <div
            key={s.id}
            className="group relative rounded-2xl p-5 bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 border border-neutral-200 dark:border-gray-700 shadow-sm overflow-hidden transition-all duration-300 hover:border-orange-500 hover:shadow-orange-500/10 hover:shadow-md"
          >
            ...
            <div className="flex items-center gap-3 mb-4 relative z-10">
              ...
              <h3 className="font-bold text-base text-neutral-900 dark:text-white leading-tight">{s.nombre}</h3>
            </div>

            {/* LISTA DE SERVICIOS */}
            <ul className="space-y-1.5 relative z-10">
              {s.lista.map((item, idx) => (
                <li key={idx} className="flex items-center gap-2 text-[13px] text-neutral-700 dark:text-gray-300">
      ...
      <div className="mt-14 mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {loading ? (
             ...
             <div className="col-span-full border border-neutral-200 dark:border-neutral-800 rounded-3xl p-8 text-center text-neutral-500 bg-white dark:bg-neutral-900/30">
             ...
             reservas.slice(0, 4).map((res) => {
              ...
              if (esActiva) {
                return (
                  <div key={res.id_reserva} className="bg-white dark:bg-gradient-to-br dark:from-neutral-900 dark:to-black border border-orange-500/30 rounded-3xl p-6 relative overflow-hidden shadow-lg shadow-orange-500/5 dark:shadow-orange-500/10 transition-transform hover:-translate-y-1">
                    ...
                    <div className="flex justify-between items-start mb-4 relative z-10">
                       <div className="flex items-center gap-4">
                         ...
                         <div>
                           <h3 className="font-bold text-lg text-neutral-900 dark:text-white leading-tight capitalize">{res.servicios?.nombre_servicio || 'Servicio General'}</h3>
                    ...
                    <div className="bg-neutral-50 dark:bg-neutral-800/60 rounded-2xl p-4 border border-neutral-100 dark:border-neutral-700/50 mt-5 backdrop-blur-sm relative z-10">
                       <div className="flex justify-between items-center text-sm mb-3">
                          <span className="text-neutral-500 dark:text-neutral-400 font-medium">Lugar</span>
                          <span className="text-neutral-900 dark:text-white font-semibold text-right truncate pl-4 max-w-[150px]">{res.direccion || 'Pendiente'}</span>
                       </div>
                       <div className="flex justify-between text-sm mb-3">
                          <span className="text-neutral-500 dark:text-neutral-400 font-medium">Fecha Programada</span>
                       ...
                       <div className="w-full bg-neutral-200 dark:bg-neutral-900 rounded-full h-2 mt-4 overflow-hidden border border-neutral-300 dark:border-neutral-800">
                ...
                return (
                  <div key={res.id_reserva} className="bg-white dark:bg-gradient-to-br dark:from-neutral-900 dark:to-black border border-neutral-200 dark:border-neutral-800 rounded-3xl p-6 relative overflow-hidden transition-transform hover:-translate-y-1 shadow-sm dark:shadow-none">
                    ...
                    <div className="flex justify-between items-start mb-4 relative z-10 opacity-85 hover:opacity-100 transition-opacity">
                       <div className="flex items-center gap-4">
                         ...
                         <div>
                           <h3 className="font-bold text-lg text-neutral-900 dark:text-white leading-tight capitalize">{res.servicios?.nombre_servicio || 'Servicio Completado'}</h3>
                    ...
                    <div className="bg-neutral-50 dark:bg-neutral-800/40 rounded-2xl p-5 border border-neutral-100 dark:border-neutral-800 mt-5 opacity-80 hover:opacity-100 transition-opacity relative z-10 space-y-3">
                       <div className="flex justify-between items-center text-sm">
                          <span className="text-neutral-500 dark:text-neutral-400 font-medium">ID Reserva</span>
                          <span className="text-neutral-600 dark:text-neutral-500 font-mono text-xs">#{res.id_reserva}</span>
                       </div>
                       <div className="flex justify-between items-center text-sm">
                          <span className="text-neutral-500 dark:text-neutral-400 font-medium">Fecha de atención</span>
                          <span className="text-neutral-700 dark:text-neutral-300 font-mono text-xs bg-white dark:bg-neutral-900 px-2.5 py-1 rounded-lg border border-neutral-200 dark:border-neutral-800">
